...
const atoms = [{
  ...
  examples: [
    ...
    {tokens: [{label:"NN", hexagram: ["lavender", "violet"], labelColor: "white"}]},
    {tokens: [{label:"OO", sexies: ["green", "brightGreen"], bar: true}]},
    {tokens: [{label:"PP", sunrise: ["lightBlue", "yellow", "orange"], bar: true}]},
  ...
  examples: [
    ...
    {track: [{side:4,type:"straight",gauge:"line",end:0.75},
             {side:5,type:"straight",gauge:"dashed"}]},
    {track: [{side:2,type:"straight",end: 0.125},
    ...
    {track: [{ type:"sharpInner", side:1 },
             { type:"sharpOuter", side:1 }]},
    {comment: "The base offset is 17.15 from center, so these are 1.5 and 0.5 times that",
     track: [{ type:"sharp", side:1, trackOffset:-25.72 },
    ...
    {track: [{ type:"gentleInner", side:1 },
             { type:"gentleOuter", side:1 },
             { type:"gentle", side:1 }]},
    {track: [{ type:"gentle", side:1, trackOffset:-25.72 },
    ...
    {track: [{ type:"straight", side:1, trackOffset:-25.72 },
    ...
    {track: [{ type:"gentleInner", side:1, radiusOffset:50 },
    ...
    {track: [{ type:"gentle", side:1, trackOffset:-25.72, radiusOffset:320 },
    ...
    {track: [{ side: 1, type: "gentle", gauge: "dashed",
               color: "match", borderColor: "match", gaugeColor: "black" },
             { side: 1, type: "straight", gauge: "dashed",
               color: "match", borderColor: "match", gaugeColor: "black" },
             { side: 2, type: "gentle", gauge: "dashed",
               color: "match", borderColor: "match", gaugeColor: "black" },
             { side: 2, type: "straight", gauge: "dashed",
               color: "match", borderColor: "match", gaugeColor: "black" },
             { side: 3, type: "gentle", gauge: "dashed",
               color: "match", borderColor: "match", gaugeColor: "black" },
             { side: 3, type: "straight", gauge: "dashed",
               color: "match", borderColor: "match", gaugeColor: "black" },
             { side: 4, type: "gentle", gauge: "dashed",
               color: "match", borderColor: "match", gaugeColor: "black" },
             { side: 5, type: "gentle", gauge: "dashed",
               color: "match", borderColor: "match", gaugeColor: "black" },
             { side: 6, type: "gentle", gauge: "dashed",
               color: "match", borderColor: "match", gaugeColor: "black" }]},
    {track: [ { side: 1, type: "gentle", gauge: "narrow",
                color: "match", borderColor: "match", gaugeColor: "black" },
              { side: 5, type: "gentle", gauge: "narrow",
                color: "match", borderColor: "match", gaugeColor: "black" },
